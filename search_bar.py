...
def SearchBar():
    return Div(cls='relative mb-20 flex w-full max-w-4xl items-center rounded-lg bg-white px-8 py-4')(
                ...
                Input(id='search-field', placeholder='Search by file name or tags', type='search', name='search', value='', cls='block h-6 w-full border-0 py-0 pl-8 pr-0 text-base leading-6 text-black outline-none placeholder:text-gray-400 focus:ring-0')
            )